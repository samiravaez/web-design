    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form class="needs-validation" action="{{ route('faqs.store') }}" method="post">
                            @csrf
                            <div class="form-row">
                                <div class="col-md-4">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item" type="button"
                                                               href="{{route("faqs.item.edit",$item->id)}}">ویرایش</a>
                                                            <form method="post"
                                                                  action="{{route("faqs.item.delete",$item->id)}}">
                                                                @csrf
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="needs-validation" method="post"
                                  action="{{(isset($faq_item))?route("faqs.item.update",$faq_item->id):route("faqs.item.store")}}">
                                @csrf
                                @isset($faq_item)
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" autocomplete="off"
                                               ...
                                               value="{{(isset($faq_item))?$faq_item->title:null}}">
                                        <div class="valid-feedback">
                                            صحیح است!
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea type="text" class="form-control" autocomplete="off" id="description"
                                                  name="description" placeholder="توضیحات" required>{{(isset($faq_item))?$faq_item->description:null}}</textarea>
                                        <div class="valid-feedback">
                                            صحیح است!
                                        </div>
                                    </div>
